...
import pytest
from torchtune.models.long_scaled_rope import LongScaledRotaryPositionalEmbeddings
...
class TestLongScaledRotaryPositionalEmbeddings:
    """
    Class for testing our Long Scaled RoPE implementation from Phi-3.
    """
